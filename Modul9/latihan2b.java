...
public class latihan2b extends JFrame {
    ...
    public static void main(String[] args) {
        ...
        latihan2b frame = new latihan2b();//membuat objek eventwarna
    ...
    public latihan2b(){
       ...
       contentPane.setBackground(Color.white);
        ...
        open.addActionListener(e->{chooser.showOpenDialog(null);});
        ...
        save.addActionListener(e->{chooser.showSaveDialog(null);});
